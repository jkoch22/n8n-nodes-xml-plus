...
export const xmlPlusOptions: INodeProperties[] = [
	{
		...
		options: [{
				...
				type: 'boolean',
				default: true,
				description: 'Whether to allow attributes with boolean values (e.g., checked, disabled)',
			},
			{
				displayName: 'Unpaired Tags',
				name: 'unpairedTags',
				type: 'string',
				default: '',
				description: 'Comma-separated list of tags that do not require a closing tag (e.g., br, img)',
			},
		]
	},
	// ----------------------------------
	...
	// ----------------------------------
	{
		...
		options: [{
			...
			},
			{
				...
				type: 'boolean',
				default: false,
				description: 'Whether to add an XML declaration at the beginning of the XML output',
			},
			{
			...
			{
				displayName: 'XML Declaration Type',
				...
				options: [{
						name: 'Standard (<?Xml version="1.0" encoding="UTF-8"?>)',
						value: 'standard',
					},
					{
						name: 'Version 1.1 (<?Xml version="1.1" encoding="UTF-8"?>)',
						value: 'version11',
					},
					{
						name: 'No Encoding (<?Xml version="1.0"?>)',
						value: 'noEncoding',
					},
				],
				default: 'standard',
				description: 'Select the XML declaration format',
			},
		],
	}
]
